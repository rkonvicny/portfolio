...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 glow-bg bg-brand-accent opacity-10 dark:opacity-15 w-80 h-80 sm:w-[500px] sm:h-[500px]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center select-none animate-fade-in-up">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-medium text-zinc-600 dark:text-zinc-400 mb-8 min-h-[40px]">
          Hledáte{" "}
