        ...
        {selectedProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl glass-panel-light dark:glass-panel-dark shadow-2xl p-6 sm:p-8 animate-fade-in-up z-10">
              ...
              {/* Popis */}
              <div className="mb-6">
                <h4 className="text-sm font-bold text-zinc-900 dark:text-white mb-2">O projektu</h4>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
              ...
              {/* Klíčové vlastnosti */}
              <div className="mb-6">
                <h4 className="text-sm font-bold text-zinc-900 dark:text-white mb-2">Klíčové funkce</h4>
              ...
              {/* Použité technologie */}
              <div className="mb-8">
                <h4 className="text-sm font-bold text-zinc-900 dark:text-white mb-2">Technologie</h4>
